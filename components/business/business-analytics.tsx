    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart<BookingStats> data={bookingStats}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis<BookingStats>
                  dataKey="date"
                  tick={{ fontSize: 12 }}
      ...
      <Card>
        ...
        <CardContent>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart<ServiceStats> data={serviceStats}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis<ServiceStats>
                  dataKey="name"
                  tick={{ fontSize: 12 }}
      ...
      <Card>
        ...
        <CardContent>
          <div className="h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart<ReviewStats> data={reviewStats}>
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis<ReviewStats>
                  dataKey="date"
                  tick={{ fontSize: 12 }}
